...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      sideOffset={6}
      className={cn(
        'z-50 max-h-72 min-w-[8rem] overflow-hidden rounded-md border border-border bg-surface shadow-popover data-[state=open]:animate-dialog-in',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 ps-7 pe-2 text-sm outline-none transition-colors',
